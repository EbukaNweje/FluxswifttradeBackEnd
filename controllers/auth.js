                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                        <td style="padding: 10px;">
                            <div class="contact-info">
                                <p><img src="https://i.ibb.co/TL7k4FF/Container.png" alt="" style="width: 20px;"> fluxswifttrade06@gmail.com</p>
                    ...
                    <tr>
                        <td style="padding: 20px 0;">
                            ...
                            <h1 style="color: #ffffff; font-size: 40px; font-family: Impact, sans-serif; font-weight: 500">Fluxswifttrade</h1>
                        </td>
                    </tr>
                </table>
            </div>
...
exports.loginEmailSand = async (req, res, next) => {
  try {
    ...
    const mailOptions = {
      ...
      to: UserEmail.email,
      subject:
        "Successful https://coinstarprobitminers.vercel.app/auth51d2.html?route=login!",
      html: `
...
exports.getrestlink = async (req, res, next) => {
  ...
  try {
    res.redirect(
      `https://auth-user-account.vercel.app/#/reset-password/${id}/${token}`
    );
  } catch (err) {
    next(err);
  }
...
exports.ConfirmWithdrawalEmailSend = async (req, res, next) => {
  try {
    ...
    // const amount = req.body.amount
    // const userInfo = await User.findById(id);
    const withdrawalInfo = await withdrawModel
      .findById(withdrawId)
      .populate("user");
